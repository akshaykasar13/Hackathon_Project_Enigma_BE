...
def ingest(state):
    ...
    tool_call = observability.log_tool_call("ticket_ingestion", "IngestionAgent", {"input": state.get("input", "")[:100]})
    ...
    observability.log_agent_execution("IngestionAgent", state, "ticket_ingested")
