...
class ToolCall:
    ...
    def __init__(self, tool_name: str, agent_name: str, inputs: Dict[str, Any]):
...
class ObservabilityLogger:
    ...
    def log_tool_call(self, tool_name: str, agent_name: str, inputs: Dict[str, Any]) -> ToolCall:
        """Log a tool call start."""
        tool_call = ToolCall(tool_name, agent_name, inputs)
    ...
    def log_agent_execution(self, agent_name: str, state: Dict[str, Any], action: str = "executed"):
        """Log agent execution."""
        event = {
    ...
    def log_decision(self, agent_name: str, decision: str, reasoning: str, data_used: Dict[str, Any]):
    ...
    def get_tool_calls(self, agent_name: Optional[str] = None) -> List[Dict[str, Any]]:
        """Get tool calls, optionally filtered by agent."""
